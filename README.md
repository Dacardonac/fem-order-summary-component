...
# Frontend Mentor - Order Summary Component solution with React ⚛️✅

![Design preview for Order Summary Component coding challenge](./public/design/desktop-preview.webp)

This is a solution to the **[Order Summary Component challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/order-summary-component-QlPmajDUj)** by **[Dacardonac](https://github.com/Dacardonac)**. Frontend Mentor challenges help you improve your coding skills by building realistic projects with Frontend.
...
- Solution URL: **[Frontend Mentor Solution 👨‍💻](https://www.frontendmentor.io/solutions/order-summary-component-with-react-_ss8KnW-Nc)**
- Live Site URL: **[Solution Deploy in Vercel 🚀](https://fem-order-summary-component-steel.vercel.app/)**
...
1. **Clone the repository**:
  ...
  ```bash
  git clone https://github.com/Dacardonac/fem-order-summary-component.git
  ```

2. **Navigate to the project directory 📂**:

  ```bash
  cd fem-order-summary-component
  ```
